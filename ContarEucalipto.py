...
def findColor(img, myColors):
    ...
    for index, color in enumerate(myColors):
        ...
        if counter != 0:
            ...
            cv2.putText(imgContour, f'Quantidade: {counter}', (100, 100), cv2.FONT_HERSHEY_COMPLEX, 0.7, (0, 0, 0), 2)
...
while True:
    img = cv2.imread("../Datasets/Eucalipto/p/eucalipto1.jpg")
